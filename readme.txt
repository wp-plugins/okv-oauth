...
This project is maintain by <a href="http://okvee.net" target="author_site">Okvee.net</a>. Feel free to rate and comments.<br>
This plugin is working perfectly with <a href="http://codecanyon.net/item/user-signlog/5741801" target="user_signlog">User Signlog</a> my premium plugin to track your logins.
